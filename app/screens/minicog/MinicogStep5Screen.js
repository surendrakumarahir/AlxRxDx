...
class MinicogStep5Screen extends Component {
  constructor() {
    ...
    this.state = {
      ...
      dataSourceWordsRecall: dataWordsRecall,
      dataSourceClock: dataClock,
  ...
  renderRow = ({item, index}) => {
    ...
    if (Platform.OS === 'android') {
     TouchableElement = TouchableNativeFeedback;
      ...
      return (
        <TouchableElement underlayColor={'#cdcdcd'} key={index} onPress={() => this.selectButton(rowData, index) }>
            ...
            <ScrollView style={sharedStyles.minicogMainContainer} contentInset={{top: 0, left: 0, right: 0, bottom: 20}}>
              <View style={[sharedStyles.patientTestContainer, sharedStyles.marginTop20]}>
                ...
                <FlatList
                      ...
                      data={this.state.dataSourceWordsRecall}
                ...
                <FlatList
                      ...
                      horizontal={true}
                      enableEmptySections={true}
                      data={this.state.dataSourceClock}
                      renderItem={this.renderRow} />
              </View>
