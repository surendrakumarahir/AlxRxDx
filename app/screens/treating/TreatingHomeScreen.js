...
class TreatingHomeScreen extends Component {
  constructor() {
    super();
        ...
        <View style={customStyles.container}>
          <View style={customStyles.body}>
            ...
            <View style={sharedStyles.homeScreenTitleContainer}>
              <Text style={sharedStyles.homeScreenMainTitle}>Treating{"\n"}Symptoms</Text>
              <Text style={sharedStyles.homeScreenSubtitle}>DICE Approach To Behavioral and {"\n"}Psychological Signs and Symptoms{"\n"}of Dementia</Text>
            </View>

            <View style={[sharedStyles.homeScreenFooter, sharedStyles.buttonContainer]}>
              <View style={[sharedStyles.button, customStyles.button]}>
                <TouchableElement underlayColor={'#cdcdcd'} style={[sharedStyles.button, customStyles.button]} onPress={() => navigate('TreatingStep1')}>
...
module.exports = TreatingHomeScreen;